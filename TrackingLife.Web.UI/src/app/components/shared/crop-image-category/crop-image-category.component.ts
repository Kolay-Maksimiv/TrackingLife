...
@Component({
  selector: 'app-crop-image-category',
  templateUrl: './crop-image-category.component.html',
  styleUrls: ['./crop-image-category.component.css']
})
export class CropImageCategoryComponent implements OnInit {
