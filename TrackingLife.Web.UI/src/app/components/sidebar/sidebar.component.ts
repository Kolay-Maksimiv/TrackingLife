...
import pageMenusAdmin from '../../config/page-menus-admin';
...
export class SidebarComponent implements AfterViewChecked {
  ...
  @Output() selectLanguageEvent = new EventEmitter<string>();
  ...
  constructor(private eRef: ElementRef, public authService: AuthService, private location: Location, private router: Router) {
   if(!this.location.path().includes('/reset-password')){
      this.menus = pageMenusAdmin;
      this.email= this.authService.currentUser ? this.authService.currentUser.email : "";
      this.organisationName = this.authService.currentUser ? this.authService.currentUser.organisationName : "";
      this.profileImg = this.authService.currentUser ? this.authService.currentUser.imageUrl : "";
     }
  ...
  selectLanguage(lauguage: string){
    this.languageName = lauguage;
    this.selectLanguageEvent.emit(lauguage);
  }
